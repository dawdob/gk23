...
public class Lab6 extends GLJPanel implements GLEventListener  {
    ...
    void trojkat(GL2 gl2) {
        ...
        float [] gold  = {0.24725f, 0.1995f, 0.0745f, 1.0f,
            0,75164f, 0,60648f, 0,22648f, 1,0,
            0,628281f, 0,555802f, 0,366065f, 1,0,
            50f,0
        };

        gl2.glBegin(GL_TRIANGLES);
        gl2.glMaterialfv(GL2.GL_FRONT_AND_BACK, GL2.GL_AMBIENT, gold, 0);
        gl2.glMaterialfv( GL2.GL_FRONT_AND_BACK, GL2.GL_DIFFUSE, gold, 4 );
        gl2.glMaterialfv( GL2.GL_FRONT_AND_BACK, GL2.GL_SPECULAR, gold, 8 );
        gl2.glMaterialf( GL2.GL_FRONT_AND_BACK, GL2.GL_SHININESS, gold[12] );
        gl2.glVertex2f(0,0);
        gl2.glVertex2f(5,0);
        gl2.glVertex2f(2.5f,5);
        gl2.glEnd();
    }
    ...
    public void display(GLAutoDrawable drawable) {
        ...
        float[] zero = { 0, 0, 0, 1 };
        gl2.glMaterialfv(GL_FRONT_AND_BACK, GL2.GL_AMBIENT_AND_DIFFUSE, gray, 0);
    ...
    public void init(GLAutoDrawable drawable) {
        ...
        gl2.glLightModeli(GL_LIGHT_MODEL_TWO_SIDE,1);
